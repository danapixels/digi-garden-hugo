...
externalLinks = [
  ...
  { title = "My own Hugo template", url = "https://themes.gohugo.io/themes/digio-theme/", date = "2025-09-28", icon = "/contribute.png", teaser = "My pixel blog for anyone to use using Hugo" }
]
+++